...
#        self.base_url = {'surged limit':'http://www.iwencai.com/stockpick/search?typed=1&preParams=&ts=1&f=1&qs=index_rewrite&selfsectsn=&querytype=stock&searchfilter=&tid=stockpick&w='+ date_str +'涨停'}
...
#获取URL
    def get_url(self,date_str):
        self.base_url = {'surged limit':'http://www.iwencai.com/stockpick/search?typed=1&preParams=&ts=1&f=1&qs=index_rewrite&selfsectsn=&querytype=stock&searchfilter=&tid=stockpick&w='+ date_str +'涨停',
                         'overall score':'http://www.iwencai.com/stockpick/search?typed=1&preParams=&ts=1&f=1&qs=result_rewrite&selfsectsn=&querytype=stock&searchfilter=&tid=stockpick&w=' + date_str + '综合评分&queryarea='}
...
#                       '问财综合评分：'}
    ...
    #更新每日股票涨停
    def update_stock(self, date_str, urlname, way = 1):
...
#    date_str = '2019-06-01'
#    fmt = '%Y-%m-%d'
    urlname = 'surged limit'
    date_list = list(self.date_stock_day['date'])[-1:]
#    
    for date_str in date_list:
        way = 1
        df_tot = self.update_stock(date_str, urlname)
